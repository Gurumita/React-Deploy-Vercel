...
const ForgetPassword = () => {
    ...
    const handleSendOtp = async (e) => {
        ...
        try {
            const response = await axios.post('https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/users/send_otp', { name, email });
    ...
    const handleForgetPassword = async (e) => {
        ...
        try {
            const otpResponse = await axios.post('https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/users/validate_otp', {
                name,
                email,
                otp,
                newPassword
