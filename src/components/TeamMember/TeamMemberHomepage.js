...
const TeamMemberHomePage = () => {
    ...
    useEffect(() => {
        const fetchUserDetails = async () => {
            try {
                const response = await fetch(`https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/users/by-username?username=${username}`);
    ...
    return (
        <div className="tm-home-container">
            ...
            <div className="tm-actions-container">
                ...
                <button onClick={() => fetchData(`https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/projects/user/${username}`, 'projects')}>View My Projects</button>
                <button onClick={() => fetchData(`https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/projects/user/${username}`, 'clients')}>View My Clients</button>
                <button onClick={() => fetchData(`https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/tasks/by-username/${username}`, 'tasks')}>View My Tasks</button>
            </div>
