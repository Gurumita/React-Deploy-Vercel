...
const Message = () => {
    ...
    const fetchProjectManagerDetails = async () => {
        try {
            const response = await fetch(`https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/projects/project-managers/team-member/${username}`);
            const data = await response.json();
    ...
    const handleMessageSubmit = async () => {
        ...
        try {
            const response = await fetch('https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/api/messages/create', {
                method: 'POST',
