...
const DeactivateUser = () => {
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                const response = await axios.get('https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/users/all');
    ...
    const handleSubmit = async (e, action) => {
        ...
        try {
            ...
            if (action === 'deactivate') {
                response = await axios.put(`https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/users/deactivate/${selectedUser}`);
                alert('User deactivated successfully!');
            } else if (action === 'activate') {
                response = await axios.put(`https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/users/activate/${selectedUser}`);
