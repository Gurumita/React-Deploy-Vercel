...
const CreateProject = () => {
    ...
    useEffect(() => {
        const fetchClients = async () => {
            try {
                const response = await axios.get('https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/clients/all');
        ...
        const fetchProjectManagers = async () => {
            try {
                const response = await axios.get('https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/users/project-managers');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/projects/create', requestBody, {
                headers: {
        ...
        <div className="create-project-container">
            ...
            <form onSubmit={handleSubmit} className="create-project-form">
                ...
                <Select
                    id="client-select"
                    name="client-select"
                    value={clients.find(client => client.value === clientId) || null}
                ...
                <Select
                    ...
                    value={projectManagers.find(manager => manager.value === projectManagerId) || null}
