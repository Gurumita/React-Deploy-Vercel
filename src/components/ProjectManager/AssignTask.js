...
const AssignTask = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/projects/by-username?username=${username}`)
            .then(response => {
        ...
        axios.get('https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/milestones')
            .then(response => {
    ...
    const handleProjectChange = (e) => {
        ...
        axios.get(`https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/projects/getTeamMembersByProjectId?projectId=${projectId}`)
            .then(response => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://revtaskman-bgf0cwfaaxg9b5e8.southindia-01.azurewebsites.net/tasks/create', dataToSubmit)
            .then(response => {
